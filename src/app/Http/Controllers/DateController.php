...
class DateController extends Controller
{
    ...
    {
        $users = User::all();
        return view('dates.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dates.index')->with('success', 'Cita creada correctamente.');
    }
    ...
    public function edit(string $id)
    {
        $date = Date::findOrFail($id);
        $users = User::all();
        return view('dates.edit', compact('date','users'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('dates.index')->with('success', 'Cita actualizada correctamente.');
    }
    ...
    public function destroy(string $id)
    {
        $date = Date::findOrFail($id);
        $date->delete();
        return redirect()->route('dates.index')->with('success', 'Cita borrada correctamente.');
    }
}
